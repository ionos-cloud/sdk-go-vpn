...
func (o *IPSecGatewayRead) HasId() bool {
	if o != nil && o.Id != nil {
		return true
	}
...
func (o *IPSecGatewayRead) HasType() bool {
	if o != nil && o.Type != nil {
		return true
	}
...
func (o *IPSecGatewayRead) HasHref() bool {
	if o != nil && o.Href != nil {
		return true
	}
...
// If the value is explicit nil, the zero value for IPSecGatewayMetadata will be returned
...
func (o *IPSecGatewayRead) HasMetadata() bool {
...
func (o *IPSecGatewayRead) HasProperties() bool {
